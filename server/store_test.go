...
func TestGetNotesAcrossFolders(t *testing.T) {
	...
	s.CreateNote(f1.ID, "Work Note 1", 2000)
	s.CreateNote(f1.ID, "Work Note 2", 3000)
	s.CreateNote(f2.ID, "Personal Note", 4000)
