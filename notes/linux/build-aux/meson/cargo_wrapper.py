...
Usage: cargo_wrapper.py --manifest-path PATH --bin NAME [--release] [--target TRIPLE] OUTPUT
"""
...
def main():
    ...
    # Inherit the full environment (includes MESON_* vars set via custom_target env:)
    env = os.environ.copy()
